...
class V6Generator:
    ...
    def group_by_length(self, distribution):
    ...
    def _check_depth_distribution(self):
        ...
        initiate_distribution = self.group_by_length(self._binary_trie.full_prefix_nodes)  # dictionary statistic from previous function
        final_distribution = self.group_by_length(self.depth_distribution)
        ...
        for i in range(len(initiate_distribution)):
            try:
                ...
                prefix_leafs = self.group_by_length(self._binary_trie.prefix_leaf_nodes)
